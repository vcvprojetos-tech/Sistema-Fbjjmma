...
export async function POST(req: NextRequest) {
  try {
    ...
    // Pega o evento mais recente dos últimos 7 dias (prioridade para eventos em andamento ou recentes)
    // Isso garante que eventos realizados ontem/hoje ainda sejam selecionados corretamente
    ...
    if (sessaoAtiva && sessaoAtiva.tatame) {
    ...
    console.error("[COORDENADOR ENTRAR ERROR]", error)
